...
import { Button, Image, StyleSheet, TextInput, View, TouchableOpacity, Modal, Text } from 'react-native';
...
export default function App() {
  ...
  const saveData = async () => {
    try {
      ...
      const profilePictureFilename = `profile_picture_${timestamp}.jpg`;
      const documentDirectory = FileSystem.documentDirectory + profilePictureFilename;
      ...
      db.transaction(tx => {
        tx.executeSql('INSERT INTO data (quote, image) VALUES (?, ?)', [quote, documentDirectory]);
      }, null, null);
